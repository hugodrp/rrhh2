...
@Embeddable
public class HistorialCambiosAsignacionExcepcionPK
    ...
    public String toString() {
        return "py.gov.mca.sisrrhh.entitys.HistorialCambiosAsignacionExcepcionPK[ codigoHistorial=" + this.codigoHistorial + ", codigoExcepcion=" + this.codigoExcepcion + ", fechaAsignacion=" + this.fechaAsignacion + ", numeroDocumentoFuncionario=" + this.numeroDocumentoFuncionario + " ]";
    }
}
